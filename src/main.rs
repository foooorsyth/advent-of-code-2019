...
mod tests {
    ...
    #[test]
    fn test_d23_p1() {
        let res_d23_p1 = d23::part1().unwrap();
        assert_eq!(res_d23_p1, 24268);
    }

    #[test]
    fn test_d23_p2() {
        let res_d23_p2 = d23::part2().unwrap();
        assert_eq!(res_d23_p2, 19316);
    }
    ...
    #[test]
    fn test_d25_p1() {
        let res_d25_p1 = d25::part1(false, false).unwrap();
        assert_eq!(res_d25_p1, "18874497");
    }
}
...
fn main() {
    ...
    match args[1].parse::<i32>().unwrap() {
        ...
        23 => {
            let res_d23_p1 = d23::part1().unwrap();
            println!("d23_p1: {}", res_d23_p1);
            let res_d23_p2 = d23::part2().unwrap();
            println!("d23_p2: {}", res_d23_p2);
        }
        24 => {
            let res_d24_p1 = d24::part1().unwrap();
